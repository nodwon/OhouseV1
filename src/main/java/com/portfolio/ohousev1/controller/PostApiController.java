...
import com.portfolio.ohousev1.dto.post.response.PostsResponseDto;
...
import static com.portfolio.ohousev1.entity.QMember.member;
...
public class PostApiController {
    ...
    //게시글 등록
    @PostMapping
    public ResponseEntity<Long> newPost(@RequestBody PostsSaveRequestDto request) {
